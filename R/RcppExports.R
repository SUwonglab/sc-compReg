...
mfbs <- function(TFName, motifName, motifWeight, elementName, match2TF, match2Motif) {
    .Call(`_scCompReg_mfbs`, TFName, motifName, motifWeight, elementName, match2TF, match2Motif)
}
